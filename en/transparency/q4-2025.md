...
### Breakpoint Abu Dhabi (December 11-13, 2025)

Superteam Brazil sent a delegation to Breakpoint, the Solana Foundation's annual flagship conference, held at the Etihad Arena, Abu Dhabi, from December 11 to 13, 2025, with side events in Dubai during the preceding week. The conference brought together builders, investors, validators, and ecosystem partners from across the global Solana network.
...
The Cypherpunk Hackathon concluded in Q4, and Brazilian teams delivered standout performances across multiple tracks. Given the global scale of competition — backed by $2.5M in Colosseum accelerator investment for winning teams on top of track prizes — these placements represent a significant achievement for the Brazilian builder community:
...
**Cloak — 3rd Place, Stablecoins Track**

Cloak placed third in the Stablecoins track of the Cypherpunk Hackathon, meaning Brazilian teams took two of the top three placements in that track (MCPay in 1st, Cloak in 3rd). Cloak focused on privacy-preserving payments infrastructure for Solana, and the team's technical execution earned recognition from the global judging panel. Victor Carvalho from the Cloak team would later join Superteam Brazil as a member in Q1 2026.

**VitalFi (now Credit.Markets) — Honorable Mention, RWA Track**

VitalFi, which has since rebranded to Credit.Markets, received an Honorable Mention in the Real World Assets (RWA) track. The project explored credit markets and real-world asset tokenization on Solana. While not a podium placement, an Honorable Mention in a hackathon backed by $2.5M in accelerator funding reflects strong execution and a viable product direction.
...
| Metric | Value |
|--------|-------|
| Hackathon placements (Brazilian teams) | 3 (1st and 3rd in Stablecoins track, Honorable Mention in RWA) |
| Bounties distributed in Q4 | $11,000+ |
| Largest single bounty | $5,000 (Solana Stablecoin Standard) |
| Conference representation | Breakpoint Abu Dhabi (December 11-13) |
